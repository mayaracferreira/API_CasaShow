    ...
    public class ShowController : Controller 
    {
     ...
     private readonly ApplicationsDbContext database;
       ...
       public IActionResult Salvar (Show show){
             if (ModelState.IsValid && show.Nome == null && show.Valor == 0 && show.Hora == null && show.Categoria == null && show.CasaseClubes ==null){
               Show Show = new Show ();
               Show.Nome = show.Nome;
            ...
            return new ObjectResult (new {msg= "Para cadastrar um evento todos os campos precisam ser preenchidos"});
